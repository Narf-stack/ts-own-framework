...
function () {
  ...
  ApiSync.prototype.save = function (data) {
    var id = data.id; // const { id }= data //ES2015 destructuring
...
function () {
  function Attributes(data) {
    ...
    this.data = data; // <K extends keyof T> is a constraint limiting the type K can be , 169
    //  K = keyOfObject
...
exports.User = User;
},{"./Eventing":"src/models/Eventing.ts","./ApiSync":"src/models/ApiSync.ts","./Attributes":"src/models/Attributes.ts","./Collection":"src/models/Collection.ts","./Model":"src/models/Model.ts"}],"src/views/View.ts":[function(require,module,exports) {
"use strict";
...
var UserEdit_1 = require("./views/UserEdit"); // const user = new User({name: 'test', age: 20});
// user.on('click',()=>{
//     console.log('hey')
// user.trigger('click')
// // console.log(user)
...
var root = document.getElementById('root'); // if( root){
